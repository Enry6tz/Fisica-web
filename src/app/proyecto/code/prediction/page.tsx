...
cap = cv2.VideoCapture(videos.get(video_seleccionado, 'Files/Videos/entra1.mp4')) #Alguna opcion invalida corre 'entra1.mp4' por default
...
`;
  ...
  return (
    <div className="bg-gray-800 text-white p-5 rounded-lg font-mono m-4">
      <h2 className="text-2xl mb-4">Código de predicción de enceste</h2>
